...
class ParserTest(unittest.TestCase):
    ...
    def test_select(self):
        ...
        p = Parser.parse(select, [lq._internal._schema], ParseType.select)[0]
    ...
    def test_rename(self):
        ...
        p = Parser.parse(rename, [lq._internal._schema], ParseType.rename)[0]
    ...
    def test_join(self):
        ...
        p = Parser.parse(join, [lq._internal._schema, jq._internal._schema], ParseType.join)[0]
    ...
    def test_filter(self):
        ...
        p = Parser.parse(filter, [lq._internal._schema], ParseType.filter)[0]
    ...
    def test_extend(self):
        ...
        p = Parser.parse(extend, [lq._internal._schema], ParseType.extend)[0]
    ...
    def test_sort(self):
        ...
        p = Parser.parse(sort, [lq._internal._schema], ParseType.order_by)[0]
    ...
    def test_fstring(self):
        ...
        p = Parser.parse(fstring, [lq._internal._schema], ParseType.extend)[0]
    ...
    def test_aggregate(self):
        ...
        p = Parser.parse(group, [lq._internal._schema], ParseType.group_by)[0]
        f = GroupByExpression(
    ...
    def test_window(self):
        ...
        p = Parser.parse(window, [lq._internal._schema], ParseType.over)[0]
